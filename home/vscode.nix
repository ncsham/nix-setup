{ pkgs, ... }:
{
  programs.vscode = {
    enable = true;
    mutableExtensionsDir = true; # Allows manual installation of extensions not in nixpkgs
    extensions = [
    ...
    userSettings = {
      ...
      "workbench.colorCustomizations" = {
        ...
        "sideBarTitle.background" = "#1e1e1e4d";
        "sideBarStickyScroll.background" = "#1e1e1e4d";
        "activityBar.background" = "#1e1e1e4d";
        "editor.background" = "#1e1e1e4d";
        "editorStickyScroll.background" = "#1e1e1ee6";
        "editorStickyScrollGutter.background" = "#1e1e1ee6";
        "tab.inactiveBackground" = "#1e1e1e4d";
        "tab.unfocusedInactiveBackground" = "#1e1e1e4d";
